...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className='mt-30  px-15'>
        <h3 className='text-gray-200'>POPULAR BOOKS</h3>
        <div className='mt-5 grid grid-cols-4 justify-items-center items-center'>
      ...
      <motion.div className='flex flex-col gap-6 text-white mt-30' initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2}} variants={{hidden: {}, visible: {transition: { staggerChildren: 0.2,},},}}>
      ...
      <div className='flex justify-between mt-30 px-20'>
        {credDescriptions.map((service) => 
          <div className='w-60 h-80 p-4 border border-gray-200 rounded-lg'>
      ...
      <div className='flex justify-center gap-10 items-center mt-30'>
        <div className='w-100 h-80 p-4 border border-gray-200 rounded-lg'>
          <h1 className='text-4xl text-white font-bold'>Our Vison</h1>
      ...
      <div className='bg-ivory w-full h-220 rounded-t-4xl mt-30 px-20 py-2'>
        ...
        <div className='flex gap-10 mt-20'>
          <div className='flex flex-col gap-4 w-full'>
            <div className='flex flex-col gap-2'>
              <h1 className='text-5xl font-bold text-[#1F150C]'>About us</h1>
          ...
          <div className='w-full'>
            <Image src="/images/home-about.avif" className='rounded-full' width={8000} height={650} alt="About section image" />
          </div>
        </div>

        <div className='text-center bg-[#1F150C] w-full h-[1px] mt-20'></div>

        {/* updated static section */}

        <div className='py-5'>
          <h1 className='text-4xl font-bold text-[#1F150C] text-center'>Library Updated statistics</h1>

          <div className='flex justify-between mt-30 px-20'>
            {updateStats.map((stat)=>
              <div key={stat.id}>
                <h1 className='text-[#1F150C] font-bold text-center text-4xl'>{`+${stat.users}`}</h1>
                <p className='text-center text-[#1F150C] mt-1'>{stat.description}</p>
              </div>
              )}
          </div>
